...
type ThetaUpdateSpeedProfile struct {
...
func MustNewThetaUpdateSpeedProfile(cfg thetaJobConfig) *ThetaUpdateSpeedProfile {
	...
	return &ThetaUpdateSpeedProfile{
		config: cfg,
		sketch: sketch,
	}
}

func (p *ThetaUpdateSpeedProfile) run() {
...
func (p *ThetaUpdateSpeedProfile) computeNumTrials(curU uint64) int {
...
func (p *ThetaUpdateSpeedProfile) runTrial(uPerTrial int) float64 {
	p.sketch.Reset()
...
func (p *ThetaUpdateSpeedProfile) process(
