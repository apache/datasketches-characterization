...
public abstract class BaseQuantilesAccuracyProfile implements JobProfile {
  ...
  private void doTrials() {
    ...
    final QuantilesDoublesSketchBuilder builder = QuantilesDoublesSketch.builder().setK(1 << errorSketchLgK);
    ...
    for (int i = 0; i < numSteps; i++) {
      ...
      final UpdatableQuantilesDoublesSketch rankErrorSketch = builder.build();
