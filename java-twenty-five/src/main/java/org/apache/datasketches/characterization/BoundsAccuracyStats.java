...
public class BoundsAccuracyStats {
  public UpdatableQuantilesDoublesSketch qskEst; //quantile sketch created by constructor
  ...
  public BoundsAccuracyStats(final int k, final int trueValue) {
    qskEst = new QuantilesDoublesSketchBuilder().setK(k).build(); //Quantiles of estimates
