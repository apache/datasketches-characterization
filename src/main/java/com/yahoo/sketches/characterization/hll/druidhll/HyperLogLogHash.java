 ...
 * This class makes it easier to achieve
 * consistent value hashing for both internal aggregation and external hashing for pre-computed
 * aggregation.
 *
 * <p>By default 128-bit murmur3 algorithm, x64 variant is used. Implementation is thread safe.
 *
 * <p>Caution! changing of implementation may cause improper cardinality estimation between data
 * hashed with different versions.
 */
public class HyperLogLogHash
{
  ...
  {
    return hash(rawValue.getBytes(UTF_8));
  }
}
