...
public class QuantilesStreamAProfile implements JobProfile {
  ...
  private boolean wasZipped = false;
  ...
  private void processStream() {
    ...
    final double[] splitpoints = buildSplitPointsArr(minV, maxV, ppOoM);
    //PMF
    ...
    println(String.format(pmfFmt, i, maxV, pmfArr[i] * n)); // the max point
