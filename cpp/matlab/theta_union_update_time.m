...
legend('Theta lgk=12 compact trimmed gcc10', 'Theta lgk=12 compact trimmed Java', 'Tuple double lgk=12 compact trimmed gcc9', 'AOD compact trimmed Java', 'AOD compact trimmed gcc9', 'location', 'northwest');
