...
theta_12_test=load('../results/theta_sketch_timing_lgk12_x8_gcc9_experimental.tsv');
...
semilogx(theta_12_test(:,1), theta_12_test(:,4), 'linewidth', 2);
...
legend('Theta lgk=12 x8 gcc9', 'Theta lgk=12 x8 gcc9 experimental', 'Tuple double lgk=12 x8 gcc9', 'AOD lgk=12 x8 gcc9', 'AOD lgk=12 x8 Java', 'location', 'northeast');
